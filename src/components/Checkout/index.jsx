...
import payment_icon_1 from '../../assets/images/payment-icon/1.png'
import payment_icon_2 from '../../assets/images/payment-icon/2.png'
import payment_icon_3 from '../../assets/images/payment-icon/3.png'
import payment_icon_5 from '../../assets/images/payment-icon/5.png'
import payment_icon_7 from '../../assets/images/payment-icon/7.png'

function Checkout() {
    return (
        <>
            <TitleBox title="Checkout" />
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 mb-3">
                                            <div className="payment-icon">
                                                <ul>
                                                    <li><img className="img-fluid" src={payment_icon_1} alt="" /></li>
                                                    <li><img className="img-fluid" src={payment_icon_2} alt="" /></li>
                                                    <li><img className="img-fluid" src={payment_icon_3} alt="" /></li>
                                                    <li><img className="img-fluid" src={payment_icon_5} alt="" /></li>
                                                    <li><img className="img-fluid" src={payment_icon_7} alt="" /></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
